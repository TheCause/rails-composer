...
An application template that creates starter applications for Rails 4.2.
...
|_. Rails 4.2 |_. Tutorial |_. Comments |
...
| "rails-devise-roles":https://github.com/RailsApps/rails-devise-roles | "Role-Based Authorization":http://railsapps.github.io/rails-devise-roles/ | authorization with roles |
...
| "rails-stripe-checkout":https://github.com/RailsApps/rails-stripe-checkout | "Stripe Checkout":https://tutorials.railsapps.org/rails-stripe-checkout | selling a product with Stripe Checkout |
| "rails-stripe-coupons":https://github.com/RailsApps/rails-stripe-coupons | "Stripe JS With Coupons":https://tutorials.railsapps.org/rails-stripe-coupons | complex Rails and Stripe integration |
| "rails-stripe-membership-saas":https://github.com/RailsApps/rails-stripe-membership-saas | "Membership Site with Stripe":https://tutorials.railsapps.org/rails-stripe-membership-saas | Stripe for recurring billing |
...
Or for Mac Os users
Choose a directory and Copy/paste railsComposer.sh onto.
"Change mod" it.<pre>$ chmod +x railsComposer.sh</pre>
then for your next project ...<pre>$ ./railsComposer.sh appName</pre>
...
With Rails 4.2, you'll see a prompt:
...
Currently, there are no contributed applications available for Rails 4.2. If you would like to add your favorite starter application to Rails Composer, open an issue to let us know.
